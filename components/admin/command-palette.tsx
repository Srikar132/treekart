  ...
  return (
    <>
      <button
        ...
        className="hidden md:flex relative items-center gap-2 w-96 px-3 h-10 bg-secondary/50 border border-transparent hover:border-primary/20 hover:bg-white transition-all rounded-lg text-xs text-muted-foreground group"
      >
