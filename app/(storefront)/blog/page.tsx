      ...
      <div className="max-w-6xl mx-auto px-6 py-20 md:py-32 space-y-20">
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-8">
          <div className="space-y-4">
            ...
            <h1 className="text-5xl md:text-8xl font-black text-foreground uppercase tracking-tighter leading-none">
          ...
          {posts.length > 0 ? (
            posts.map((post) => (
              ...
              >
                ...
                <div className="md:col-span-7 space-y-4">
                  <h2 className="text-2xl md:text-3xl font-black text-foreground uppercase tracking-tight group-hover:text-primary transition-colors leading-none">
                    {post.title}
                  </h2>
            ...
            <div className="flex flex-col items-center justify-center py-32 space-y-6 text-center border-b border-border/40">
              ...
              <div className="space-y-2">
                <h3 className="text-xl font-black text-foreground uppercase tracking-tight">No Stories Found</h3>
        ...
        {totalPages > 1 && (
          <div className="flex items-center justify-between pt-10 border-t border-border/40">
            <Link 
              ...
              className={`flex items-center gap-3 text-[10px] font-black uppercase tracking-widest transition-colors ${currentPage > 1 ? 'text-foreground hover:text-primary' : 'text-muted-foreground pointer-events-none opacity-30'}`}
            >
              <ChevronLeft size={16} />
              Previous
            </Link>
            ...
            <Link 
              href={`/blog?page=${currentPage + 1}`}
              className={`flex items-center gap-3 text-[10px] font-black uppercase tracking-widest transition-colors ${currentPage < totalPages ? 'text-foreground hover:text-primary' : 'text-muted-foreground pointer-events-none opacity-30'}`}
            >
              Next
