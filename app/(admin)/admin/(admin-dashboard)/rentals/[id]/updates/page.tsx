      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-12">
        ...
        <div className="lg:col-span-7 space-y-6">
          <div className="flex items-center justify-between px-1">
            <p className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Historical Log ({updates.length})</p>
          ...
          <div className="relative space-y-8 before:absolute before:left-5 before:top-4 before:bottom-4 before:w-px before:bg-slate-100">
            ...
            {updates.length === 0 && (
              <div className="data-card text-center py-20 border-dashed border-2 bg-slate-50/50">
                <div className="h-12 w-12 bg-white rounded-full flex items-center justify-center mx-auto mb-4 text-slate-300">
                  <ImageIcon size={20} />
                </div>
  ...
  return (
    <div className="relative pl-12 group">
      ...
      <div className="data-card group-hover:border-primary/20 transition-all duration-300 hover:shadow-md">
        ...
        <p className="text-xs text-slate-600 leading-relaxed mb-6 font-medium">{update.description}</p>


        {update.video_url && (
          <div className="h-20 w-36 rounded-xl bg-slate-900 flex items-center justify-center text-white gap-2 border border-slate-800 shadow-xl group/video cursor-pointer hover:bg-black transition-colors">
