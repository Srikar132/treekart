  ...
  return (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="space-y-4">
        ...
        <div>
          <h1 className="text-2xl font-black text-slate-900 uppercase tracking-tight">Edit Story</h1>
          <p className="text-xs font-bold text-slate-400 uppercase tracking-widest">Updating journal entry #{blog.id.slice(0, 8)}</p>
        </div>
      </div>
